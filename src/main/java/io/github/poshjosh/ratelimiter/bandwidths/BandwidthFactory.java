...
import static io.github.poshjosh.ratelimiter.bandwidths.BandwidthFactories.getOrCreateBandwidthFactory;
...
public interface BandwidthFactory {
    ...
    static Class<? extends BandwidthFactory> getDefaultClass() {
        return BandwidthFactory.Default.class;
    }
