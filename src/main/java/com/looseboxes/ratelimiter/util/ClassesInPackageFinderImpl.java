 ...
 * @author hp
 */
public class ClassesInPackageFinderImpl implements ClassesInPackageFinder{

    private static final Logger LOG = LoggerFactory.getLogger(ClassesInPackageFinderImpl.class);
    
    private final ClassLoader classLoader;

    public ClassesInPackageFinderImpl() {
        this(Thread.currentThread().getContextClassLoader());
        
    }
    
    public ClassesInPackageFinderImpl(ClassLoader classLoader) {
