...
abstract class SmoothRateLimiter extends RateLimiter {
    ...
    static final class SmoothWarmingUp extends SmoothRateLimiter {
        ...
        SmoothWarmingUp(
                RateLimiter2.SleepingStopwatch stopwatch, long warmupPeriod, TimeUnit timeUnit, double coldFactor) {
            super(stopwatch);
    ...
    static final class SmoothBursty extends SmoothRateLimiter {
        ...
        SmoothBursty(RateLimiter2.SleepingStopwatch stopwatch, double maxBurstSeconds) {
            super(stopwatch);
    ...
    private SmoothRateLimiter(RateLimiter2.SleepingStopwatch stopwatch) {
        super(stopwatch);
    }
